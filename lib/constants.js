...
export const RPC = 'https://rpc-fast-1.sentinel.co:443';
...
export const SIGNING_RPC_URLS = [
  // Primary per operator directive (2026-06-11): rpc-fast-1 leads every pool.
  // Verified in-sync at chain tip (height 29097112, catching_up=false).
  'https://rpc-fast-1.sentinel.co:443',
...
export const MSG_SHARE_SUBSCRIPTION_TYPE = '/sentinel.subscription.v3.MsgShareSubscriptionRequest';
